...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($csrf) || !hash_equals($_SESSION['csrf'], $csrf)) {
        ...
        echo "Session Invalid. Please reload the page.\nSesi Tidak Valid. Silakan muat ulang halaman.";
        exit;
    }
